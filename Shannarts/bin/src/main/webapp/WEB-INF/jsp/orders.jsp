...
<body>
            ...
            <div class="table-responsive">
                <table class="orders-table">
                    ...
                    <tbody>
                        ...
                        <!-- 
                            NOTE: In a real JSP, you would replace this hardcoded example with a JSTL loop over a list of Transaction objects.
                            Example: <c:forEach var="txn" items="${transactionList}">
                            
                            The data attributes are used by JavaScript to populate the modal.
                        -->
    ...
    <div id="orderDetailsModal" class="modal">
        <div class="modal-content">
            ...
            <!-- Transaction Summary from 'transactions' table -->
            ...
            <!-- Status Update Form (Action points to your status update servlet) -->
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            detailButtons.forEach(button => {
                button.addEventListener('click', (event) => {
                    ...
                    modalTotal.textContent = `₱${parseFloat(total).toLocaleString('en-US', { minimumFractionDigits: 2 })}`;
                    ...
                    items.forEach(item => {
                        ...
                        tr.innerHTML = `
                            <td>${item.name}</td>
                            <td>₱${parseFloat(item.unitPrice).toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                            <td>${item.quantity}</td>
